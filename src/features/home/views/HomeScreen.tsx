...
const styles = StyleSheet.create({
  ...
  brand: { height: 54, justifyContent: 'center', transform: [{ translateX: -12 }], width: 164 }, brandLogo: { height: 54, width: 120 },
  avatar: { alignItems: 'center', borderRadius: 20, height: 40, justifyContent: 'center', width: 40 }, avatarText: { fontFamily: fontFamilies.semibold, fontSize: 13 },
