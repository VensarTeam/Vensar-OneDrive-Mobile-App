...
const styles = StyleSheet.create({
  ...
  pathBar: { alignItems: 'center', flexDirection: 'row', gap: 10, paddingTop: 20 }, backButton: { alignItems: 'center', borderRadius: 14, height: 44, justifyContent: 'center', width: 44 }, homeButton: { alignItems: 'center', borderCurve: 'continuous', borderRadius: 14, borderWidth: StyleSheet.hairlineWidth, height: 44, justifyContent: 'center', width: 44 }, pathCopy: { flex: 1 }, pathTitle: { fontFamily: fontFamilies.semibold, fontSize: 15 }, pathMeta: { fontFamily: fontFamilies.regular, fontSize: 11, paddingTop: 2 },
